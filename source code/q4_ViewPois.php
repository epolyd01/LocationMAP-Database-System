...
<body>
	...
	<hr>
  <h2>View Pois in Floor with id <?php echo $FID?></h2>
	...
	$tsql=   "
SELECT POIsID,POIName,P.Type,P.X,P.Y,P.Description
FROM POIs P INNER JOIN Floor F ON f.FloorID= $FID
ORDER BY P.POIsID,P.Type" ;
  ...
  $FID = $_GET['Get1'];
echo("<td><a href='q4_InsertPois.php?Get1=$FID'>Insert Pois</a></td>");//esu to evales
      ...
      $id = $row['POIsID'];
          ...
          echo("<td><a href='q4_DeletePois.php?Get1=$id'>Delete</a></td>");//esu to evales
